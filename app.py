...
if uploaded_file:
    ...
    # 4. Forcer le démarrage au 12/06/2023 inclus
    df = df[df["Horodate"] >= pd.Timestamp("2023-06-12 00:00:00")]

    # 5. Vérification des bornes
    if df.empty:
        st.error("❌ Aucune donnée valide trouvée après le 12/06/2023. Vérifiez le fichier et son format.")
    else:
        ...
        if st.button("🚀 Lancer le traitement"):
            ...
            # 9. Agrégation selon le mode choisi
            ...
            # 10. Diagnostic des heures par jour
